		...
		spa.main = (function(){
			var configMap = {
				templateManage : String()
					...
					+'<form  style="text-align:left; color:#fff;" id="formmanage">'
									+'Name:<br>'
				...
				templateAzure : String()
					...
					+'<form  style="text-align:left; color:#fff;" id="formmazure">'
									+'Azure:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Key :<br>'
				...
				,templatePLC : String()
					...
					+'<form  style="text-align:left; color:#fff;" id="formplc">'
									+'Name:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Last name :<br>'
				...
				,templateNodeMCU : String()
					...
					+'<form  style="text-align:left; color:#fff;" id="formnodemcu">'
									+'Name:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'Last name :<br>'
				...
				templateNodeSnap7 : String()
					+'<div class="spa-main-form" style="height:400px; background-color: #8A2BE2;">'
					+'<form  style="text-align:left; color:#fff;" id="formnodesnap7">'
									+'Project Name:<br>'
									+'<input style="margin:10px;" type="text" name="firstname" id="firstname">'
									+'<br>'
									+'IP :<br>'
